...
class GlobalConstants
{
    ...
    public const ORG_TOKEN_CACHE_KEY = 'user_token:'; // 客户端令牌缓存标识

    public const ORG_REFRESH_TOKEN_CACHE_KEY = 'user_refresh_token:'; // 客户端刷新令牌缓存标识

    public const SYS_TOKEN_TYPE = 'SYS'; // 系统总后台令牌类型标识

    public const SYS_TOKEN_KEY = 'System-Token'; // 系统总后台令牌标识

    public const SYS_TOKEN_CACHE_KEY = 'admin_token:'; // 系统总后台令牌缓存标识
